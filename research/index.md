...
<div class="research-layout">
  ...
  <div class="research-content">
    ...
    <section class="research-home-section" aria-labelledby="current-research">
      <h2 id="current-research" class="research-section-title">Current and Continuing GPS/PNT Research</h2>
      ...
      <p class="research-section-link">
        <a href="{{ '/research/current-and-continuing-gpspnt-research/' | relative_url }}">View all current and continuing research</a>
      </p>
    </section>

    <section class="research-home-section" aria-labelledby="early-research">
      <h2 id="early-research" class="research-section-title">Early GPS/PNT Research</h2>
      ...
      <p class="research-section-link">
        <a href="{{ '/research/early-gpspnt-research/' | relative_url }}">View all early GPS/PNT research</a>
      </p>
    </section>
